package com.gamehost.storage

import android.content.Context
import com.gamehost.content.RootStore
import com.gamehost.presentation.PresentationSnapshot
 ...
 * with the campaign in `.gamehost/slots.json` (§6.1), not in app-private storage.
 */
private const val PREFS_NAME = "gamehost"
...
class PrefsSnapshotStore(context: Context) : SnapshotStore {
    ...
    override fun load(): PresentationSnapshot? {
        ...
        return PresentationSnapshot(
            imageId = imageId,
            scaling = scaling,
            blackout = prefs.getBoolean(KEY_BLACKOUT, false),
    ...
    override fun save(snapshot: PresentationSnapshot) {
        prefs.edit()
            ...
            .putBoolean(KEY_BLACKOUT, snapshot.blackout)
    ...
    private companion object {
        ...
        const val KEY_BLACKOUT = "presentation_blackout"
