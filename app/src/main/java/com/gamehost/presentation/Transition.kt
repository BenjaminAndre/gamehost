...
data class TransitionSpec(
    ...
    companion object {
        ...
        /**
         * Blanking keeps the uniform rule but is clamped to this.
         *
         * Nothing is readable in seven frames, so the panic button still feels instant —
         * and the state changes immediately regardless, so control responsiveness was
         * never actually at stake. This is how "transitions apply to every change" and
         * "NOIR must be instant" are both true.
         */
        const val BLANK_MAX_MILLIS = 120
