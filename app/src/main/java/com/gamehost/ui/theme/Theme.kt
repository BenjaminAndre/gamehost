 ...
 */
private val GamehostColors = darkColorScheme(
...
@Composable
fun GamehostTheme(content: @Composable () -> Unit) {
    MaterialTheme(colorScheme = GamehostColors, content = content)
}
