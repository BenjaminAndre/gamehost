...
import com.brigade.content.ContentSource
 ...
 *
 * The only file in Brigade that knows `DocumentsContract` exists.
 *
...
class DocumentTreeSource(
    ...
    /**
     * **Invariant:** every [ContentId] in Brigade is a *document* URI built using the
